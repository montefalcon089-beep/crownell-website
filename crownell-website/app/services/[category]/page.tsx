...
export default async function CategoryPage({ params }: Props) {
  ...
  return (
    <main style={{ padding: "40px 20px", maxWidth: 1200, margin: "0 auto" }}>
      ...
      <h1 style={{ fontSize: 36, marginBottom: 10 }}>{category.title}</h1>
      <p style={{ marginBottom: 30, color: "#666" }}>{category.subtitle}</p>

      {category.heroImage ? (
        <div style={{ marginBottom: 28, borderRadius: 18, overflow: "hidden" }}>
          <Image
